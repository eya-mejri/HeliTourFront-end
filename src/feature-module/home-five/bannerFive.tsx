                    ...
                    <div className="row align-items-center">
                        <div className="col-md-12 mx-auto">
                            ...
                            <div className="banner-content aos" data-aos="fade-up">
                                <h1 className="text-white display-5">Discover the World's Most Breathtaking Cruises</h1>
                                <h6 className="text-white mx-auto">Explore stunning destinations and world-class experiences aboard our award-winning ships</h6>
                            </div>
                            <div className="banner-form card mb-0 aos" data-aos="fade-up">
                                <div className="card-header">
                                    <ul className="nav">
                                        ...
                                        <li>
                                            <Link to="#" className="nav-link" data-bs-toggle="tab" data-bs-target="#Cars">
